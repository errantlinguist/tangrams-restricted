...
# Fits a linear mixed-effects model (LMM) for the results of cross-validation on reference resolution for the game "tangrams-restricted", comparing the training methods "ONE_NEG", "ALL_NEG" and "DIALOGIC".
#
