 ...
 *
 */
final class ImageEdgeCountFactory implements ToDoubleFunction<String> {
	...
	private static Properties loadEdgeCountProps() {
		...
		try (InputStream instream = ImageEdgeCountFactory.class.getResourceAsStream("edgeCounts.properties")) {
	...
	public ImageEdgeCountFactory() {
		this(createPropValMap(loadEdgeCountProps()));
	}

	public ImageEdgeCountFactory(final Object2DoubleMap<String> resourceEdgeCounts) {
