 ...
 *
 */
public final class WordsAsClassifiersCrossValidationStatisticsWriter {
	...
	private enum Parameter implements Supplier<Option> {
		...
		private static void printHelp() {
			...
			formatter.printHelp(WordsAsClassifiersCrossValidationStatisticsWriter.class.getSimpleName() + " INFILE",
					OPTIONS);
		}
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(WordsAsClassifiersCrossValidationStatisticsWriter.class);
		...
		if (cl.hasOption(Parameter.HELP.optName)) {
			...
			if (inpaths.isEmpty()) {
				...
				try (final ClassPathXmlApplicationContext appCtx = new ClassPathXmlApplicationContext(
						"entity-feature-extraction.xml", WordsAsClassifiersCrossValidationStatisticsWriter.class)) {
					final WordsAsClassifiersCrossValidationTester tester = appCtx
