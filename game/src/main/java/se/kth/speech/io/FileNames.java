...
public final class FileNames {
	...
	public static Map<Path, String> createPathLeafNameMap(final Collection<Path> paths, final int depth, // NO_UCD (use private)
		...
		final Map<Path, String> result = Maps.newHashMapWithExpectedSize(paths.size());
	 ...
	 *         given replacement.
	 */
	public static String sanitize(final CharSequence fileName, final String replacement) { // NO_UCD (use default)
