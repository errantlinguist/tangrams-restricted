 ...
 *
 */
final class TimestampingScreenshotLogger implements BiConsumer<Component, String> {
	...
	TimestampingScreenshotLogger(final BiConsumer<? super Component, ? super String> screenshotLogger,
	...
	public void accept(final Component view, final String filenamePrefix) {
		...
		final String filename = filenamePrefix + timestamp;
		screenshotLogger.accept(view, filename);
